	...
	<div>
		...
		<div class="mian">
			<mt-swipe :auto="4000" :showIndicators="true">
				<mt-swipe-item >
					<img  @click="banner_detail" src="../images/banner01.png" />
				</mt-swipe-item>
				<mt-swipe-item>
					<img  @click="banner_detail" src="../images/banner01.png" />
				</mt-swipe-item>
			...
			<div class="need">
				<mt-cell title="最新需求"  >
					<span @click="nowNeed">查看更多 <img src="../images/img05.png"  alt=""> </span>
					<img slot="icon" src="../images/img04.png" >
				</mt-cell>
			</div>
			<!--空白行  -->
